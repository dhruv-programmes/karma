...
TRANSACTIONS: list[Transaction] = [
    ...
    Transaction(id=UUID("44444444-4444-4444-4444-444444444403"), date="2026-02-08", merchant="Flipkart Refurbished Accessories", amount_inr=2200, category=ProductCategory.ELECTRONICS),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444404"), date="2026-02-12", merchant="BESCOM Electricity", amount_inr=1850, category=ProductCategory.ENERGY),
    ...
    Transaction(id=UUID("44444444-4444-4444-4444-444444444407"), date="2026-02-22", merchant="Amazon Sustainable Home", amount_inr=1299, category=ProductCategory.HOME),
    ...
    Transaction(id=UUID("44444444-4444-4444-4444-444444444411"), date="2026-03-06", merchant="Croma Eco Cable", amount_inr=899, category=ProductCategory.ELECTRONICS),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444412"), date="2026-03-07", merchant="Reliance Digital Solar Powerbank", amount_inr=2499, category=ProductCategory.ELECTRONICS),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444413"), date="2026-03-08", merchant="Amazon Secondhand Books", amount_inr=599, category=ProductCategory.OTHER),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444414"), date="2026-03-09", merchant="BESCOM Household Electricity", amount_inr=1850, category=ProductCategory.ENERGY),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444415"), date="2026-03-10", merchant="Zomato", amount_inr=460, category=ProductCategory.FOOD),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444416"), date="2026-03-11", merchant="Rapido Bike Taxi", amount_inr=95, category=ProductCategory.TRANSPORT),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444417"), date="2026-03-11", merchant="BigBasket Groceries", amount_inr=1450, category=ProductCategory.FOOD),
    ...
    Transaction(id=UUID("44444444-4444-4444-4444-444444444419"), date="2026-03-14", merchant="Blinkit Essentials", amount_inr=720, category=ProductCategory.FOOD),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444420"), date="2026-03-15", merchant="Myntra Eco Cotton Wear", amount_inr=1650, category=ProductCategory.CLOTHING),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444421"), date="2026-03-16", merchant="Namma Metro Card Topup", amount_inr=350, category=ProductCategory.TRANSPORT),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444422"), date="2026-03-18", merchant="FabIndia Recycled Cushion", amount_inr=1200, category=ProductCategory.HOME),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444423"), date="2026-03-20", merchant="Nykaa Clean Skincare", amount_inr=850, category=ProductCategory.PERSONAL_CARE),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444424"), date="2026-03-22", merchant="Jayanagar Tailor Repair", amount_inr=250, category=ProductCategory.CLOTHING),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444425"), date="2026-03-24", merchant="Flipkart Solar Charger", amount_inr=1299, category=ProductCategory.ELECTRONICS),
    Transaction(id=UUID("44444444-4444-4444-4444-444444444426"), date="2026-03-26", merchant="Swiggy Farm Bowls", amount_inr=510, category=ProductCategory.FOOD),
]
