...
export default function ChallengesScreen() {
  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={[styles.content, { paddingTop: insets.top + 12, paddingBottom: insets.bottom + 32 }]} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={refresh} tintColor={mint} />}>
      <Pressable style={styles.back} onPress={() => router.canGoBack() ? router.back() : router.replace("/community")}><ArrowLeft size={18} color={green} /><Text style={styles.backText}>Community</Text></Pressable>
...
const styles = StyleSheet.create({
  ...
  back: { flexDirection: "row", alignItems: "center", gap: 6, paddingVertical: 5 }, backText: { color: green, fontWeight: "700" },
