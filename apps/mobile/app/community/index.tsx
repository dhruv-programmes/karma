...
import { ArrowLeft, ChevronRight, Crown, Gift, Shield, Users } from "lucide-react-native";
...
export default function CommunityHubScreen() {
  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={[styles.content, { paddingTop: insets.top + 12, paddingBottom: insets.bottom + 32 }]}>
      <Pressable style={styles.back} onPress={() => router.canGoBack() ? router.back() : router.replace("/(tabs)")}>
      ...
      <View style={styles.options}>
        ...
        <Pressable style={styles.option} onPress={() => router.push("/leaderboard") }>
          <View style={[styles.optionIcon, { backgroundColor: "#FFF3D9" }]}><Crown size={24} color="#D58B19" /></View>
          <View style={styles.optionCopy}>
      ...
      <Pressable style={styles.leagueCard} onPress={() => router.push("/league")}>
        <View style={styles.leagueBadge}><Shield size={21} color="#D58B19" /></View>
        <View style={styles.leagueCopy}>
          <Text style={styles.leagueEyebrow}>YOUR SEASON</Text>
          <Text style={styles.leagueTitle}>Silver League · 640 pts</Text>
          <Text style={styles.leagueDescription}>Climb through verified green actions.</Text>
        </View>
